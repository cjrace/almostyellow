...
export const cocktails = [
    {
        ...
        recipe: {
            ingredients: ['2 x Tequila', '1 x Triple sec', '1 x Lime juice', 'Few drops Agave syrup', '1 x Grand marnier'],
            instructions: [
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['2 x Toffee vodka', '1 x Khalua (or Tia Maria)', '1 x Espresso pod'],
            instructions: [
                'Need to redo this to retest the method',
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['2 x Spiced rum', '4 x Orange juice (or just top to preference)', '1 x Grenadine'],
            instructions: [
                'Need to redo this to retest the method',
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['2 x Gin', '1 x Lemon juice', '1 x Sugar syrup', '1 x Egg white', 'Soda water'],
            instructions: [
                'Need to redo this to retest the method',
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['2 x Baileys', '3 x Chocomel (or milk)', 'Vanilla ice cream'],
            instructions: [
                'Need to redo this to retest the method',
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['1 x White rum', '1 x Spiced rum', '1 x Orange curacao', '1 x Orgeat syrup', '1 x Lime juice', '2 x Pineapple juice', 'Grenadine (optional)'],
            instructions: [
                'Need to redo this to retest the method',
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['2 x Gin', '1 x Lemon juice', '1 x Sugar syrup', '1 x Fruity liquer (chambord, creme de chassis etc)'],
            instructions: [
                'Need to redo this to retest the method',
                'Add all ingredients to a cocktail shaker with ice',
                'Shake loads',
    ...
    },
    {
        ...
        photoUrl: "/images/cocktail-placeholder.jpg",
        recipe: {
            ingredients: ['2 x Tequila', '1 x Triple sec', '1 x Lemon juice', '4 x orange juice', 'Grenadine'],
            instructions: [
                'Need to redo this to retest the method',
